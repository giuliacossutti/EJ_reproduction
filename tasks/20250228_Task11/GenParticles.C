...
root -l EJ_reproduction/tasks/20250228_Task11/GenParticles.C'("EJ_reproduction/tasks/20250221_Task10/50K_Reclustering.root",selection)'
*/
...
void DrawHist(Int_t sel, std::vector<TH1F*> hist, Bool_t Norm, TString XTitle, TString YTitle, std::array<Double_t,4> leglimits, TString legtitle, std::vector<TString> legentry, TString filename){
  ...
  TString head;
  if(sel==0) head = "#splitline{#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}}{EJ selection - " + legtitle + "}";
  if(sel==1) head = "#splitline{#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}}{no sel. on pT - " + legtitle + "}";
  if(sel==2) head = "#splitline{#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}}{no selection - " + legtitle + "}";
  ...
  TString printname;
  TString dir = "/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/";
  if(Norm==kFALSE){
...
//-------------------------------------------------------
  ...
  if(selection==0 & Norm==kFALSE) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/qD.root","RECREATE");
  if(selection==1 & Norm==kFALSE) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/qD_nopT.root","RECREATE");
  if(selection==2 & Norm==kFALSE) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/qD_nopTeta.root","RECREATE");
  if(selection==0 & Norm==kTRUE) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/qD_Norm.root","RECREATE");
  if(selection==1 & Norm==kTRUE) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/qD_nopT_Norm.root","RECREATE");
  if(selection==2 & Norm==kTRUE) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/qD_nopTeta_Norm.root","RECREATE");
