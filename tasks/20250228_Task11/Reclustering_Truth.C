...
Studies with MC Truth GenJets and ReclusteredGenJets 
...
root -l EJ_reproduction/tasks/20250228_Task11/Reclustering_Truth.C'("EJ_reproduction/tasks/20250221_Task10/50K_Reclustering.root",filter,Norm)'
*/
...
void Reclustering_Truth(const char *inputFile,Int_t filter=0,Bool_t Norm=kFALSE)
{
  ...
  */
  ...
  TH1F *Invmass_2small = new TH1F("Invariant_mass_of_Leading_and_Subleading_small_jets", "", 162, 0.0, 6480.0);
  TH1F *Invmass_4small = new TH1F("Invariant_mass_of_first four_small_jets", "", 162, 0.0, 6480.0);
  TH1F *Invmass_2large = new TH1F("Invariant_mass_of_Leading_and_Subleading_large_jets", "", 162, 0.0, 6480.0);
...
//-----------------------------------------------------------------
  ...
  if(filter==0) legend->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{Number of Jets with Reclustering - MC Truth - EJ}}","C");
  if(filter==1) legend->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{Number of Jets with Reclustering - MC Truth - no pT}}","C");
  if(filter==2) legend->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{Number of Jets with Reclustering - MC Truth - no sel}}","C");
  ...
  if(NjetsNorm==kFALSE){
    if(filter==0) c1->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/Njets.pdf"); 
    if(filter==1) c1->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/Njets_nopT.pdf"); 
    if(filter==2) c1->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/Njets_nopTeta.pdf"); 
  }else if(NjetsNorm==kTRUE){
    if(filter==0) c1->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/Njets_Norm.pdf"); 
    if(filter==1) c1->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/Njets_nopT_Norm.pdf"); 
    if(filter==2) c1->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/Njets_nopTeta_Norm.pdf"); 
  }
...
//-------------------------------------------------------
  ...
  if(filter==0){
    Invmass_2large->GetXaxis()->SetTitle("Invariant Mass [GeV/c^2]");
    if(InvMassNorm == kTRUE){Invmass_2large->GetYaxis()->SetTitle("#frac{1}{N} #frac{dN}{dM_{inv}} [c^2/GeV]");}
    else{Invmass_2large->GetYaxis()->SetTitle("a.u.");}

    // Show resulting histograms
    Invmass_2large->Draw("E,HIST");
    Invmass_4small->Draw("E,HIST same");
    Invmass_2small->Draw("E,HIST same");
  ...
  // Legend
  TLegend* legendIM = new TLegend(0.552632,0.555556,0.863409,0.871528);

  if(filter==0) legendIM->SetHeader("#splitline{#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}}{Invariant Mass of Jets - MC Truth - EJ}","C");
  if(filter==1) legendIM->SetHeader("#splitline{#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}}{Invariant Mass of Jets - MC Truth - no pT}","C");
  if(filter==2) legendIM->SetHeader("#splitline{#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}}{Invariant Mass of Jets - MC Truth - no sel}","C");
  ...
  if(InvMassNorm==kFALSE){
    if(filter==0) c2->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/InvMass.pdf"); 
    if(filter==1) c2->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/InvMass_nopT.pdf"); 
    if(filter==2) c2->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/InvMass_nopTeta.pdf"); 
  }else if(InvMassNorm==kTRUE){
    if(filter==0) c2->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/InvMass_Norm.pdf"); 
    if(filter==1) c2->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/InvMass_nopT_Norm.pdf"); 
    if(filter==2) c2->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/InvMass_nopTeta_Norm.pdf"); 
  }
...
//----------------------------------------------
  ...
  if(filter==0) legendDR->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta R between Jets - MC Truth - EJ}}","C");
  if(filter==1) legendDR->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta R between Jets - MC Truth - no pT}}","C");
  if(filter==2) legendDR->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta R between Jets - MC Truth - no sel}}","C");
  ...
  if(DeltaRNorm==kFALSE){
    if(filter==0) c3->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaR.pdf"); 
    if(filter==1) c3->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaR_nopT.pdf"); 
    if(filter==2) c3->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaR_nopTeta.pdf"); 
  }else if(DeltaRNorm==kTRUE){
    if(filter==0) c3->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaR_Norm.pdf"); 
    if(filter==1) c3->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaR_nopT_Norm.pdf"); 
    if(filter==2) c3->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaR_nopTeta_Norm.pdf"); 
  }
...
//----------------------------------------------
  ...
  if(filter==0) legendDEta->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta #eta between Jets - MC Truth - EJ}}","C");
  if(filter==1) legendDEta->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta #eta between Jets - MC Truth - no pT}}","C");
  if(filter==2) legendDEta->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta #eta between Jets - MC Truth - no sel}}","C");
  ...
  if(DeltaEtaNorm==kFALSE){
    if(filter==0) c4->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaEta.pdf"); 
    if(filter==1) c4->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaEta_nopT.pdf"); 
    if(filter==2) c4->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaEta_nopTeta.pdf"); 
  }else if(DeltaEtaNorm==kTRUE){
    if(filter==0) c4->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaEta_Norm.pdf"); 
    if(filter==1) c4->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaEta_nopT_Norm.pdf"); 
    if(filter==2) c4->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaEta_nopTeta_Norm.pdf"); 
  }
...
//----------------------------------------------
  ...
  if(filter==0) legendDPhi->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta #varphi between Jets - MC Truth - EJ}}","C");
  if(filter==1) legendDPhi->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta #varphi between Jets - MC Truth - no pT}}","C");
  if(filter==2) legendDPhi->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta #varphi between Jets - MC Truth - no sel}}","C");
  ...
  if(DeltaPhiNorm==kFALSE){
    if(filter==0) c5->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaPhi.pdf"); 
    if(filter==1) c5->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaPhi_nopT.pdf"); 
    if(filter==2) c5->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaPhi_nopTeta.pdf"); 
  }else if(DeltaPhiNorm==kTRUE){
    if(filter==0) c5->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaPhi_Norm.pdf"); 
    if(filter==1) c5->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaPhi_nopT_Norm.pdf"); 
    if(filter==2) c5->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/DeltaPhi_nopTeta_Norm.pdf"); 
  }
...
//-------------------------------------------------------
  ...
  if(JetPTNorm==kTRUE) JetPT_small->GetYaxis()->SetRangeUser(0.000001,0.03);
  ...
  if(filter==0) legendPT->SetHeader("#splitline{#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}}{pT of Jets - MC Truth - EJ}","C");
  if(filter==1) legendPT->SetHeader("#splitline{#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}}{pT of Jets - MC Truth - no pT}","C");
  if(filter==2) legendPT->SetHeader("#splitline{#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}}{pT of Jets - MC Truth - no sel}","C");
  ...
  if(JetPTNorm==kFALSE){
    if(filter==0) c6->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/JetPT.pdf"); 
    if(filter==1) c6->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/JetPT_nopT.pdf"); 
    if(filter==2) c6->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/JetPT_nopTeta.pdf"); 
  }else if(JetPTNorm==kTRUE){
    if(filter==0) c6->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/JetPT_Norm.pdf"); 
    if(filter==1) c6->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/JetPT_nopT_Norm.pdf"); 
    if(filter==2) c6->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/JetPT_nopTeta_Norm.pdf"); 
  }
...
//-------------------------------------------------------
  ...
  if(filter==0 & Norm==kFALSE) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/plots.root","RECREATE");
  if(filter==1 & Norm==kFALSE) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/plots_nopT.root","RECREATE");
  if(filter==2 & Norm==kFALSE) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/plots_nopTeta.root","RECREATE");
  if(filter==0 & Norm==kTRUE) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/plots_Norm.root","RECREATE");
  if(filter==1 & Norm==kTRUE) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/plots_nopT_Norm.root","RECREATE");
  if(filter==2 & Norm==kTRUE) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250228_Task11/plots_nopTeta_Norm.root","RECREATE");
