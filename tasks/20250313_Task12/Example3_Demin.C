...
void AnalyseEvents(ExRootTreeReader *treeReader, TestPlots *plots)
{
  ...
  TClonesArray *branchJet = treeReader->UseBranch("ReclusteredJet");
  TClonesArray *branchSubJet = treeReader->UseBranch("JetEnergyScaledJet");
...
void Example3_Demin(const char *inputFile)
{
