...
root -l EJ_reproduction/tasks/20250906_ThesisPlots/Reclustering.C'("EJ_reproduction/tasks/20250221_Task10/50K_Reclustering.root")'
*/
...
void CustomizeHist(TH1F* hist, Style_t style, Color_t color, Bool_t scale = kFALSE){
  ...
  hist->GetXaxis()->SetTitleSize(.050);
  hist->GetYaxis()->SetTitleSize(.050);
  hist->GetXaxis()->SetLabelSize(.050);
  hist->GetYaxis()->SetLabelSize(.050);
}
//=================================
...
void Reclustering(const char *inputFile,Int_t filter=0)
{
  ...
  // if 2: no analysis selection at all
  //Int_t filter = 0;
  ...
  */
  ...
  TH1F *Invmass_2small = new TH1F("Invariant_mass_of_Leading_and_Subleading_small_jets", "", 150, 0.0, 6000.0);
  TH1F *Invmass_4small = new TH1F("Invariant_mass_of_first four_small_jets", "", 150, 0.0, 6000.0);
  ...
  TH1F *DeltaEta_large = new TH1F("DeltaEta_between_leading_and_subleading_jets_with_R1.0", "", 220, -6., 16.);
  TH1F *DeltaEta_large2 = new TH1F("DeltaEta_between_leading_and_subleading_jets_with_R1.0_if_exactly_2_jets", "", 220, -6., 16.);
  TH1F *DeltaEta_small = new TH1F("DeltaEta_between_leading_and_subleading_jets_with_R0.4", "", 220, -6., 16.);

  TH1F *DeltaPhi_large = new TH1F("DeltaPhi_between_leading_and_subleading_jets_with_R1.0", "", 240, -7., 17.);
  TH1F *DeltaPhi_large2 = new TH1F("DeltaPhi_between_leading_and_subleading_jets_with_R1.0_if_exactly_2_jets", "", 240, -7., 17.);
  TH1F *DeltaPhi_small = new TH1F("DeltaPhi_between_leading_and_subleading_jets_with_R0.4", "", 240, -7., 17.);

  TH1F *JetPT_small = new TH1F("all_small_jet_pt", "", 300, 0.0, 3000.0);
  TH1F *JetPT1_small = new TH1F("leading_small_jet_pt", "", 300, 0.0, 3000.0);
  TH1F *JetPT2_small = new TH1F("subleading_small_jet_pt", "", 300, 0.0, 3000.0);
  TH1F *JetPT12_small = new TH1F("pt_of_first_two_small_jets", "", 300, 0.0, 3000.0);
  TH1F *JetPT4_small = new TH1F("pt_of_first_four_small_jets", "", 300, 0.0, 3000.0);

  TH1F *JetPT_large = new TH1F("all_large_jet_pt", "", 300, 0.0, 3000.0);
  TH1F *JetPT1_large = new TH1F("leading_large_jet_pt", "", 300, 0.0, 3000.0);
  TH1F *JetPT2_large = new TH1F("subleading_large_jet_pt", "", 300, 0.0, 3000.0);
  TH1F *JetPT12_large = new TH1F("pt_of_first_two_large_jets", "", 300, 0.0, 3000.0);
  ...
  //------------- Jet Filter ------------------
  // Jet Filter: >=2 jets with |eta| < 2.4 and pT > 125 GeV
    ...
    if( (filter == 0 || filter == 1 ) & (nOkJets < 2) ) continue;
  ...
  //------------- End Jet Filter ------------------
     ...
     {
       Jet *jet = (Jet*) branchJet->At(jetentry);
       if( (filter == 0 || filter == 1 ) & (abs(jet->Eta) >= 2.5) ) continue;
       index_small += 1;
       ...
       if (index_small == 1 || index_small == 2){
         //LoopOverConstituents(jet, "SMALL");   
     ...
     for(Int_t jetentry = 0; jetentry < branchReclusteredJet->GetEntries(); ++jetentry)
     {
       ...
       if( (filter == 0 || filter == 1 ) & (abs(jet->Eta) >= 1.8) ) continue;
       index_large += 1;
       ...
       if (index_large == 1 || index_large == 2){   
         //LoopOverConstituents(jet, "LARGE");   
...
//-----------------------------------------------------------------
  ...
  TLegend* legend = new TLegend(0.437343,0.40625,0.750627,0.862847);

  if(filter==0) legend->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{Number of Jets with Reclustering - EJ selection}}","C");
  if(filter==1) legend->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{Number of Jets with Reclustering - no selection on pT}}","C");
  if(filter==2) legend->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{Number of Jets with Reclustering - no selection}}","C");
  ...
  /*
  if(NjetsNorm==kFALSE){
    if(filter==0) c1->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/Njets.pdf"); 
    if(filter==1) c1->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/Njets_nopT.pdf"); 
    if(filter==2) c1->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/Njets_nopTeta.pdf"); 
  }else if(NjetsNorm==kTRUE){
    if(filter==0) c1->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/Njets_Norm.pdf"); 
    if(filter==1) c1->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/Njets_nopT_Norm.pdf"); 
    if(filter==2) c1->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/Njets_nopTeta_Norm.pdf"); 
  }
  */

  if((NjetsNorm==kTRUE) && (filter==0)) c1->SaveAs("/gfsvol01/atlas/giuliac/plots_and_outputs/Zprimethesisplots/Njets_Norm.pdf"); 
  if((NjetsNorm==kTRUE) && (filter==2)) c1->SaveAs("/gfsvol01/atlas/giuliac/plots_and_outputs/Zprimethesisplots/Njets_nopTeta_Norm.pdf"); 
...
/*
  ...
  if(filter==0) legendIM->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{Invariant Mass of Jets - EJ selection}}","C");
  if(filter==1) legendIM->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{Invariant Mass of Jets - no selection on pT}}","C");
  if(filter==2) legendIM->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{Invariant Mass of Jets - no selection}}","C");
  ...
  if(InvMassNorm==kFALSE){
    if(filter==0) c2->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/InvMass.pdf"); 
    if(filter==1) c2->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/InvMass_nopT.pdf"); 
    if(filter==2) c2->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/InvMass_nopTeta.pdf"); 
  }else if(InvMassNorm==kTRUE){
    if(filter==0) c2->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/InvMass_Norm.pdf"); 
    if(filter==1) c2->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/InvMass_nopT_Norm.pdf"); 
    if(filter==2) c2->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/InvMass_nopTeta_Norm.pdf"); 
  }
...
//----------------------------------------------
  ...
  DeltaR_large->SetLabelSize(0.050, "X");
  DeltaR_large->SetLabelSize(0.050, "Y");
  DeltaR_large->SetTitleSize(0.050, "X");
  DeltaR_large->SetTitleSize(0.050, "Y");
  ...
  TLegend* legendDR = new TLegend(0.536341,0.503472,0.849624,0.869792);

  if(filter==0) legendDR->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta R between Jets - EJ selection}}","C");
  if(filter==1) legendDR->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta R between Jets - no selection on pT}}","C");
  if(filter==2) legendDR->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta R between Jets - no selection}}","C");
  ...
  if(DeltaRNorm==kFALSE){
    if(filter==0) c3->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaR.pdf"); 
    if(filter==1) c3->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaR_nopT.pdf"); 
    if(filter==2) c3->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaR_nopTeta.pdf"); 
  }else if(DeltaRNorm==kTRUE){
    if(filter==0) c3->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaR_Norm.pdf"); 
    if(filter==1) c3->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaR_nopT_Norm.pdf"); 
    if(filter==2) c3->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaR_nopTeta_Norm.pdf"); 
  }
  */

  if((DeltaRNorm==kTRUE) && (filter==0)) c3->SaveAs("/gfsvol01/atlas/giuliac/plots_and_outputs/Zprimethesisplots/DeltaR_Norm.pdf"); 
...
//----------------------------------------------
  ...
  DeltaEta_small->SetLabelSize(0.050, "X");
  DeltaEta_small->SetLabelSize(0.050, "Y");
  DeltaEta_small->SetTitleSize(0.050, "X");
  DeltaEta_small->SetTitleSize(0.050, "Y");
  ...
  TLegend* legendDEta = new TLegend(0.536341,0.503472,0.849624,0.869792);

  if(filter==0) legendDEta->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta #eta between Jets - EJ selection}}","C");
  if(filter==1) legendDEta->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta #eta between Jets - no selection on pT}}","C");
  if(filter==2) legendDEta->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta #eta between Jets - no selection}}","C");
  ...
  if(DeltaEtaNorm==kFALSE){
    if(filter==0) c4->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaEta.pdf"); 
    if(filter==1) c4->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaEta_nopT.pdf"); 
    if(filter==2) c4->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaEta_nopTeta.pdf"); 
  }else if(DeltaEtaNorm==kTRUE){
    if(filter==0) c4->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaEta_Norm.pdf"); 
    if(filter==1) c4->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaEta_nopT_Norm.pdf"); 
    if(filter==2) c4->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaEta_nopTeta_Norm.pdf"); 
  }
  */

  if((DeltaEtaNorm==kTRUE) && (filter==0)) c4->SaveAs("/gfsvol01/atlas/giuliac/plots_and_outputs/Zprimethesisplots/DeltaEta_Norm.pdf"); 
...
//----------------------------------------------
  ...
  DeltaPhi_large->SetLabelSize(0.050, "X");
  DeltaPhi_large->SetLabelSize(0.050, "Y");
  DeltaPhi_large->SetTitleSize(0.050, "X");
  DeltaPhi_large->SetTitleSize(0.050, "Y");
  ...
  TLegend* legendDPhi = new TLegend(0.536341,0.503472,0.849624,0.869792);

  if(filter==0) legendDPhi->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta #varphi between Jets - EJ selection}}","C");
  if(filter==1) legendDPhi->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta #varphi between Jets - no selection on pT}}","C");
  if(filter==2) legendDPhi->SetHeader("#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{#splitline{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}{#Delta #varphi between Jets - no selection}}","C");
  ...
  if(DeltaPhiNorm==kFALSE){
    if(filter==0) c5->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaPhi.pdf"); 
    if(filter==1) c5->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaPhi_nopT.pdf"); 
    if(filter==2) c5->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaPhi_nopTeta.pdf"); 
  }else if(DeltaPhiNorm==kTRUE){
    if(filter==0) c5->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaPhi_Norm.pdf"); 
    if(filter==1) c5->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaPhi_nopT_Norm.pdf"); 
    if(filter==2) c5->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/DeltaPhi_nopTeta_Norm.pdf"); 
  }
  */

  if((DeltaPhiNorm==kTRUE) && (filter==0)) c5->SaveAs("/gfsvol01/atlas/giuliac/plots_and_outputs/Zprimethesisplots/DeltaPhi_Norm.pdf"); 
...
/*
  ...
  if(filter==0) legendPT->SetHeader("#splitline{#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}}{pT of Jets - EJ selection}","C");
  if(filter==1) legendPT->SetHeader("#splitline{#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}}{pT of Jets - no selection on pT}","C");
  if(filter==2) legendPT->SetHeader("#splitline{#splitline{Model D, m_{Zv} = 3.0 TeV, c#tau_{#pi_{D}} = 50 mm}{PYTHIA8+DELPHES, #sqrt{s}=13.6 TeV}}{pT of Jets - no selection}","C");
  ...
  if(JetPTNorm==kFALSE){
    if(filter==0) c6->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/JetPT.pdf"); 
    if(filter==1) c6->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/JetPT_nopT.pdf"); 
    if(filter==2) c6->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/JetPT_nopTeta.pdf"); 
  }else if(JetPTNorm==kTRUE){
    if(filter==0) c6->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/JetPT_Norm.pdf"); 
    if(filter==1) c6->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/JetPT_nopT_Norm.pdf"); 
    if(filter==2) c6->SaveAs("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/JetPT_nopTeta_Norm.pdf"); 
  }
...
/*
  ...
  if(filter==0) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/plots.root","RECREATE");
  if(filter==1) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/plots_nopT.root","RECREATE");
  if(filter==2) TFile *f = new TFile("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250221_Task10/plots_nopTeta.root","RECREATE");
