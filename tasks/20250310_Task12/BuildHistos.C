...
Macro to fill histograms of eta of leading and subleading large jet and invariant mass of these two for signal and two backgrounds

From inside the /gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes directory run with
root -l -q EJ_reproduction/tasks/20250310_Task12/BuildHistos.C'("EJ_reproduction/tasks/20250221_Task10/50K_Reclustering.root", "signal", sel)' &
root -l -q EJ_reproduction/tasks/20250310_Task12/BuildHistos.C'("EJ_reproduction/tasks/20250310_Task12/50K_bkg_Top.root", "bkg_Top", sel)' &
root -l -q EJ_reproduction/tasks/20250310_Task12/BuildHistos.C'("EJ_reproduction/tasks/20250310_Task12/50K_bkg_HardQCD.root", "bkg_HardQCD", sel)' &
  ...
  */
  ...
  for(Int_t entry = 0; entry < numberOfEntries; ++entry)
  {
    ...
    //------------- End Event selection ------------------
     ...
     // Fill Invariant Mass and Eta histogram
     if(index_large >= 2){
...
//-------------------------------------------------------
  ...
  TString outname;
  outname.Form("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250310_Task12/%s_%d.root",outFile,sel);
