...
root -l -q EJ_reproduction/tasks/20250428_Task17/HighMjj.C'("signal")' &
root -l -q EJ_reproduction/tasks/20250428_Task17/HighMjj.C'("bkgTop")' &
root -l -q EJ_reproduction/tasks/20250428_Task17/HighMjj.C'("bkgHardQCD")' &
...
void HighMjj(const char *inFile)
{
  ...
  for (Int_t i = 1; i <= 10; i++){
    inname.Form("/gfsvol01/atlas/giuliac/condor/20250428_Task17/root_outputs/50K_%s_%d.root",inFile,i);
    chain.Add(inname);
...
//------------------------------------------------
  ...
  TString outfilename;
  outfilename.Form("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250428_Task17/%s.txt",inFile);
  ofstream outfile;
  outfile.open(outfilename);

  outfile << "This file contains number of events passing high mjj selection in the sample " << inFile << endl;
  outfile << "" << endl;
...
//-------------------------------------------------------
  ...
  TString outname;
  outname.Form("/gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes/EJ_reproduction/tasks/20250428_Task17/%s.root",inFile);
